...
final class ProgressTrackerTests: XCTestCase {
    ...
    func testUpdateStatistics_CalculatesAccuracy() {
        ...
        // When
        sut.updateStatistics(&stats, sessionDuration: 1000, flashcardsReviewed: 10, correctFlashcards: 8)
    ...
    func testUpdateStatistics_UpdatesAverageAccuracyOverMultipleSessions() {
        ...
        // When
        sut.updateStatistics(&stats, sessionDuration: 1000, flashcardsReviewed: 10, correctFlashcards: 8) // 80%
        sut.updateStatistics(&stats, sessionDuration: 1000, flashcardsReviewed: 10, correctFlashcards: 10) // 100%
    ...
    func testCheckAchievements_UnlocksStreakAchievement() {
        ...
        // When
        let newlyUnlocked = sut.checkAchievements(stats: stats, unlockedAchievements: &unlockedAchievements)
