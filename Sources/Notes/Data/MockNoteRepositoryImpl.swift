...
public final class MockNoteRepositoryImpl: NoteRepositoryProtocol {
    ...
    public func getNotes(for classId: UUID) async throws -> [Note] {
    ...
    public func getNote(by id: UUID) async throws -> Note {
        // Simulate network delay
        try await Task.sleep(nanoseconds: 300_000_000)
    ...
    public func getLinkedNotes(for noteId: UUID) async throws -> [Note] {
        // Simulate network delay
        try await Task.sleep(nanoseconds: 300_000_000)
    ...
    public func searchNotes(query: String, classId: UUID?) async throws -> [Note] {
        // Simulate network delay
        try await Task.sleep(nanoseconds: 300_000_000)
