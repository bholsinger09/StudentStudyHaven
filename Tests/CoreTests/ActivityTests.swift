...
final class MockActivityRepositoryTests: XCTestCase {
    ...
    func testGetActivities_ReturnsUserActivities() async throws {
        // Given
        let activity1 = Activity.classCreated(userId: testUserId, className: "Class 1", classId: "1")
        let activity2 = Activity.noteCreated(userId: testUserId, noteTitle: "Note 1", noteId: "1", classId: "1")
        let otherActivity = Activity.classCreated(userId: otherUserId, className: "Other", classId: "2")
    ...
    func testGetActivities_RespectsLimit() async throws {
        ...
        for i in 1...5 {
            let activity = Activity.classCreated(userId: testUserId, className: "Class \(i)", classId: "\(i)")
    ...
    func testGetActivitiesByType_FiltersCorrectly() async throws {
        // Given
        let classActivity = Activity.classCreated(userId: testUserId, className: "Class", classId: "1")
        let noteActivity = Activity.noteCreated(userId: testUserId, noteTitle: "Note", noteId: "1", classId: "1")
        let flashcardActivity = Activity.flashcardReviewed(userId: testUserId, count: 5, classId: "1", className: "Class")
    ...
    func testGetActivitiesByType_ReturnsEmptyForNoMatches() async throws {
        ...
        // When
        let activities = try await sut.getActivitiesByType(for: testUserId, type: .achievementUnlocked)
    ...
    func testGetActivitiesForClass_ReturnsClassActivities() async throws {
        // Given
        let classId = "class-123"
        let classActivity = Activity.classCreated(userId: testUserId, className: "Class", classId: classId)
        let noteActivity = Activity.noteCreated(userId: testUserId, noteTitle: "Note", noteId: "1", classId: classId)
        let otherClassActivity = Activity.classCreated(userId: testUserId, className: "Other", classId: "other")
    ...
    func testDeleteActivitiesForUser_RemovesAllUserActivities() async throws {
        // Given
        _ = try await sut.createActivity(Activity.classCreated(userId: testUserId, className: "Class 1", classId: "1"))
        _ = try await sut.createActivity(Activity.noteCreated(userId: testUserId, noteTitle: "Note 1", noteId: "1", classId: "1"))
        _ = try await sut.createActivity(Activity.classCreated(userId: otherUserId, className: "Other", classId: "2"))
