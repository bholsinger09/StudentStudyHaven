...
public class AICollegeStatsService {
    ...
    private func generateStatsLocally(for collegeName: String) -> CollegeStats {
        ...
        if lowerName.contains("harvard") || lowerName.contains("yale")
            || lowerName.contains("princeton")
        {
        ...
        if lowerName.contains("cornell") || lowerName.contains("brown")
            || lowerName.contains("penn")
        {
