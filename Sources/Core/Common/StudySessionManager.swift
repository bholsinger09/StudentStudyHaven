...
public final class StudySessionManager: ObservableObject {
    ...
    private func completeCurrentSession() {
        ...
        if var session = currentSession {
            ...
            session.actualDuration =
                session.endTime.timeIntervalSince(session.startTime) - totalPausedDuration
    ...
    public var sessionsUntilLongBreak: Int {
        let remaining =
            configuration.sessionsBeforeLongBreak
            - (completedSessions % configuration.sessionsBeforeLongBreak)
