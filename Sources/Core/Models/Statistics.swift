...
extension Achievement {
    public static let allAchievements: [Achievement] = [
        // Streak achievements
        Achievement(
            id: "streak_3", title: "Getting Started", description: "Study 3 days in a row",
            category: .streak, requirement: 3, icon: "flame.fill"),
        Achievement(
            id: "streak_7", title: "Week Warrior", description: "Study 7 days in a row",
            category: .streak, requirement: 7, icon: "flame.fill"),
        Achievement(
            id: "streak_14", title: "Two Week Champion", description: "Study 14 days in a row",
            category: .streak, requirement: 14, icon: "flame.fill"),
        Achievement(
            id: "streak_30", title: "Month Master", description: "Study 30 days in a row",
            category: .streak, requirement: 30, icon: "flame.fill"),

        // Study time achievements
        Achievement(
            id: "time_10", title: "First Steps", description: "Study for 10 hours total",
            category: .studyTime, requirement: 600, icon: "clock.fill"),
        Achievement(
            id: "time_50", title: "Dedicated Student", description: "Study for 50 hours total",
            category: .studyTime, requirement: 3000, icon: "clock.fill"),
        Achievement(
            id: "time_100", title: "Century Club", description: "Study for 100 hours total",
            category: .studyTime, requirement: 6000, icon: "clock.fill"),

        // Flashcard achievements
        Achievement(
            id: "flashcard_100", title: "Card Novice", description: "Review 100 flashcards",
            category: .flashcards, requirement: 100, icon: "rectangle.stack.fill"),
        Achievement(
            id: "flashcard_500", title: "Card Expert", description: "Review 500 flashcards",
            category: .flashcards, requirement: 500, icon: "rectangle.stack.fill"),
        Achievement(
            id: "flashcard_1000", title: "Card Master", description: "Review 1000 flashcards",
            category: .flashcards, requirement: 1000, icon: "rectangle.stack.fill"),

        // Note achievements
        Achievement(
            id: "note_10", title: "Note Starter", description: "Create 10 notes", category: .notes,
            requirement: 10, icon: "doc.text.fill"),
        Achievement(
            id: "note_50", title: "Prolific Writer", description: "Create 50 notes",
            category: .notes, requirement: 50, icon: "doc.text.fill"),

        // Class achievements
        Achievement(
            id: "class_5", title: "Multi-Tasker", description: "Add 5 classes", category: .classes,
            requirement: 5, icon: "book.fill"),
        Achievement(
            id: "class_10", title: "Full Schedule", description: "Add 10 classes",
            category: .classes, requirement: 10, icon: "book.fill"),
    ]
}
...
public final class ProgressTracker {
    ...
    public func updateStatistics(
        ...
        if flashcardsReviewed > 0 {
            ...
            let totalCorrect =
                stats.flashcardAccuracy * Double(stats.totalFlashcardsReviewed - flashcardsReviewed)
                + Double(correctFlashcards)
