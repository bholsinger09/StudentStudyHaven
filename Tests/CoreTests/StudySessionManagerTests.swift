...
final class StudySessionManagerTests: XCTestCase {
    ...
    func testSessionType_DisplayNames_AreCorrect() {
        ...
        XCTAssertEqual(
            StudySessionManager.SessionType.shortBreak(minutes: 5).displayName, "Short Break")
        XCTAssertEqual(
            StudySessionManager.SessionType.longBreak(minutes: 15).displayName, "Long Break")
    }
